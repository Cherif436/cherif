...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <a className="flex items-center justify-center px-2 py-1 my-2 border border-yellow-500 rounded-full cursor-pointer hover:bg-gradient-to-l dark:bg-dark-200 dark:bg-black-500" href="/images/CV Cherif-Merzoud.pdf" download="CV Cherif-Merzoud.pdf"><AiOutlineFilePdf className="w-6 h-6 text-red-500" /> Télécharger le CV</a>
            ...
            <div className="relative w-auto max-w-3xl mx-auto my-6">
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-end p-6 bg-white border-t border-solid rounded-b border-blueGray-200 dark:bg-dark-200 dark:bg-black-500">
                  ...
                  <a className="px-6 py-3 mb-1 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear rounded shadow outline-none bg-gradient-to-r bg-emerald-500 active:bg-emerald-600 hover:shadow-lg focus:outline-none" href="/images/CV Cherif-Merzoud.pdf" download="CV Cherif-Merzoud.pdf"> Télécharger le CV</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none bg-gradient-to-t from-yellow-200 to-transparent">
            <div className="relative w-auto mx-auto my-6 max-w-7xl">
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-lg outline-none focus:outline-none">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2521.125513963725!2d4.249381715806971!3d50.81031316925022!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c3c7000b8a84cb%3A0x1365cdb4cf0f9301!2sGroenstraat%208%2C%201602%20Sint-Pieters-Leeuw!5e0!3m2!1sfr!2sbe!4v1623345503633!5m2!1sfr!2sbe" width="350" height="375" style={{ border: 0 }} loading="lazy"></iframe>
              </div>
            </div>
          </div>
        </>
